...
g++ -g -o run_test_snapshot test_snapshot.cpp ../src/version.cpp ../src/sstable.cpp ../src/primarysst.cpp ../src/hash.cpp  ../src/fio.cpp ../src/encode.cpp  ../src/compaction.cpp  ../src/lsmtree.cpp  ../src/skiplist.cpp -I../src -lpthread -std=c++14
